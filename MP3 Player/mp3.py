...
songtrack = Text(trackframe, width=40, height=2, font=("Arial", 15,),
 bg='#8a1583', fg="white", state=DISABLED)
songtrack.grid(row=0 , column=0, padx=10, pady=5)


trackstatus = Label(trackframe, textvariable= status, font=("Sans-serif", 15, "bold"),
 bg='#8a1553', fg='white')
...
unpausebtn =Button(buttonframe, text='Unpause', width=10, height=1, font=('Arial',16),
...
songframe =  LabelFrame(root, text="Song Playlist",  font=("Arial", 15, "bold"),
bg= "grey", fg='white', bd=5, relief=GROOVE)
songframe.place(x=0 , y=0, width=600, height=200)


scroll_y= Scrollbar(songframe, orient=VERTICAL)
playlist = Listbox(songframe, selectbackground="gold", selectmode=SINGLE,
...
os.chdir(r"C:\Users\Home-PC\Music\Playlists")
